...
from ch_02_02_isp_applied import CribbageDeck, cribbage_card_factory
import random
from collections.abc import MutableSequence

# Each of the special methods (iter, getitem, setitem, and len) delegates the real work to the underlying list object.
class DeckW:
